...
class BodyModel(nn.Module):
    ...
    def forward(self, root_orient=None, pose_body=None, pose_hand=None, pose_jaw=None, pose_eye=None, betas=None,
        ...
        root_orient =   root_orient.to(arg.device)
        pose_body   =   pose_body.to(arg.device)
        pose_hand   =   pose_hand.to(arg.device)
        pose_jaw    =   pose_jaw.to(arg.device)
        pose_eye    =   pose_eye.to(arg.device)
        ...
        if self.use_dmpl:
            ...
            expression = expression.to(arg.device)
